...
async function start() {
	...
	if (config.voxspark && config.voxspark.enabled && window.voxsparkSurfaceHostRuntime && !window.voxsparkSurfaceHostRuntime.readState().enabled) window.voxsparkSurfaceHostRuntime.configureBridgeUrl(config.voxspark.bridgeUrl);
