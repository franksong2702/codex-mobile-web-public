...
function measureViewport(input = {}) {
	...
	const keyboardOverlay = Boolean(keyboardInputActive && input.composerInputActive === true && input.standaloneMobilePwa === true && input.visualViewportAvailable === true && visual && layout && !keyboardCandidate && !offsetKeyboardShifted && !scrollKeyboardShifted);
