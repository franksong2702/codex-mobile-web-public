...
var api$3 = Object.freeze({ createComposerRuntime });
root$2.CodexComposerRuntime = api$3;
//#endregion
...
async function answerServerRequest(requestId, payload, options = {}) {
	...
	try {
		const result = await api$2(`/api/approvals/${encodeURIComponent(key)}`, {
			method: "POST",
...
function answerApproval(requestId, decision, options = {}) {
	...
	return api$2(`/api/approvals/${encodeURIComponent(key)}`, {
		method: "POST",
...
async function mutateThreadTaskCard(cardId, action, body = {}, options = {}) {
	...
	try {
		const result = await api$2(`/api/thread-task-cards/${encodeURIComponent(id)}/${encodeURIComponent(action)}`, {
			method: "POST",
...
async function createThreadTaskCardDraft(draftKey, options = {}) {
	...
	try {
		...
		const result = await api$2("/api/thread-task-cards", {
			method: "POST",
			body: JSON.stringify({
...
voxsparkSurfaceHostRoot.CodexVoxSparkSurfaceHostRuntime = api$1;
//#endregion
...
var moduleApis = {
	"composer-runtime": api$3,
	"composer-bridge-runtime": api$2,
	"voxspark-surface-host-runtime": api$1,
