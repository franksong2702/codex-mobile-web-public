...
function createEsmCompatibilityShardVirtualModuleSource(root, moduleDefinitions) {
  ...
  "  }",
    ...
    "    const accepted = functionReady(api, \"safeBridgeUrl\")",
    "      ? api.safeBridgeUrl(\"ws://127.0.0.1:8790/host\")",
    "      : \"\";",
    "    const rejectedQuery = functionReady(api, \"safeBridgeUrl\")",
    "      ? api.safeBridgeUrl(\"ws://127.0.0.1:8790/host?token=secret\")",
    "      : \"invalid\";",
    "    return {",
    "      ok: accepted === \"ws://127.0.0.1:8790/host\"",
    "        && rejectedQuery === \"\"",
    "        && functionReady(api, \"createVoxSparkSurfaceHostRuntime\"),",
    "      accepted,",
    "      rejectedQuery,",
    "    };",
    "  }",
