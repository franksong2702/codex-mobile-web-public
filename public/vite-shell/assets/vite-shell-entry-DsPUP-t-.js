...
var _virtual_codex_mobile_shell_build_manifest_default = {
	...
	"shellCacheName": "codex-mobile-shell-v625-87cf361d3d3f",
	"clientBuildId": "0.1.11|codex-mobile-shell-v625-87cf361d3d3f",
...
var codexMobileViteEntryGroupLoaders = {
	"manifest": () => __vitePreload(() => import("./vite-entry-group-manifest-CI23i-Ih.js"), []),
	"foundation": () => __vitePreload(() => import("./vite-entry-group-foundation-DK-7tNDo.js"), []),
	"feature-runtimes": () => __vitePreload(() => import("./vite-entry-group-feature-runtimes-oxLJhi9h.js"), []),
	"bootstrap-state": () => __vitePreload(() => import("./vite-entry-group-bootstrap-state-BXhRCwAk.js"), []),
	"shell-services": () => __vitePreload(() => import("./vite-entry-group-shell-services-Bfj8LCpv.js"), []),
	"app-entry": () => __vitePreload(() => import("./vite-entry-group-app-entry-DDciGl58.js"), [])
};
...
var esmCompatibilityImportPromise = __vitePreload(() => import("./_virtual_codex-mobile-esm-compatibility-Ejz7O24J.js").then(async (module) => {
...
async function loadViteOwnedAppBootstrap(loaderPlan) {
	...
	if (!globalThis.CodexAppBootstrap || typeof globalThis.CodexAppBootstrap.createAppBootstrapRuntime !== "function") await __vitePreload(() => import("./app-bootstrap-DXlPWHZ4.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1)), []);
...
var deferredEntryTopologyPromise = __vitePreload(() => import("./vite-deferred-entry-topology-9FI5MQAz.js"), []);
