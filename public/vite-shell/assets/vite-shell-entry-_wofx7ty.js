...
var _virtual_codex_mobile_shell_build_manifest_default = {
	...
	"shellCacheName": "codex-mobile-shell-v625-9b4de33d6458",
	"clientBuildId": "0.1.11|codex-mobile-shell-v625-9b4de33d6458",
...
var codexMobileViteEntryGroupLoaders = {
	"manifest": () => __vitePreload(() => import("./vite-entry-group-manifest-DNRNngEW.js"), []),
	"foundation": () => __vitePreload(() => import("./vite-entry-group-foundation-yEvts89h.js"), []),
	"feature-runtimes": () => __vitePreload(() => import("./vite-entry-group-feature-runtimes-Dh30rNQD.js"), []),
	"bootstrap-state": () => __vitePreload(() => import("./vite-entry-group-bootstrap-state-DAMD8CgQ.js"), []),
	"shell-services": () => __vitePreload(() => import("./vite-entry-group-shell-services-DOtjvGFF.js"), []),
	"app-entry": () => __vitePreload(() => import("./vite-entry-group-app-entry-BCJyKmdC.js"), [])
};
...
var esmCompatibilityImportPromise = __vitePreload(() => import("./_virtual_codex-mobile-esm-compatibility-DPLInkXx.js").then(async (module) => {
...
async function loadViteOwnedAppBootstrap(loaderPlan) {
	...
	if (!globalThis.CodexAppBootstrap || typeof globalThis.CodexAppBootstrap.createAppBootstrapRuntime !== "function") await __vitePreload(() => import("./app-bootstrap-CVmKCGT6.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1)), []);
...
var deferredEntryTopologyPromise = __vitePreload(() => import("./vite-deferred-entry-topology-v4owihJK.js"), []);
