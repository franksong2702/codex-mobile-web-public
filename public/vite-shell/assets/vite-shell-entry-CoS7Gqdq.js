...
var _virtual_codex_mobile_shell_build_manifest_default = {
	...
	"shellCacheName": "codex-mobile-shell-v625-38eb4eac006d",
	"clientBuildId": "0.1.11|codex-mobile-shell-v625-38eb4eac006d",
...
var codexMobileViteEntryGroupLoaders = {
	"manifest": () => __vitePreload(() => import("./vite-entry-group-manifest-BU55SemL.js"), []),
	"foundation": () => __vitePreload(() => import("./vite-entry-group-foundation-Bf7xssDY.js"), []),
	"feature-runtimes": () => __vitePreload(() => import("./vite-entry-group-feature-runtimes-CuodSqCU.js"), []),
	"bootstrap-state": () => __vitePreload(() => import("./vite-entry-group-bootstrap-state-BqNbGyxn.js"), []),
	"shell-services": () => __vitePreload(() => import("./vite-entry-group-shell-services-vWc7RC4c.js"), []),
	"app-entry": () => __vitePreload(() => import("./vite-entry-group-app-entry-riLSx1Ee.js"), [])
};
...
var esmCompatibilityImportPromise = __vitePreload(() => import("./_virtual_codex-mobile-esm-compatibility-DMadn0lo.js").then(async (module) => {
...
async function loadViteOwnedAppBootstrap(loaderPlan) {
	...
	if (!globalThis.CodexAppBootstrap || typeof globalThis.CodexAppBootstrap.createAppBootstrapRuntime !== "function") await __vitePreload(() => import("./app-bootstrap-D_ePwXEa.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1)), []);
...
var deferredEntryTopologyPromise = __vitePreload(() => import("./vite-deferred-entry-topology-Cm3gc5VC.js"), []);
